export const ROUTES = {
  ...
  ADMIN_CATEGORIES_CLASSES: "/admin/categories/classes",
  ADMIN_CATEGORIES_BATCHES: "/admin/categories/batches",
  ...
  ADMIN_GENERAL_PAYMENT_METHODS: "/admin/general/payment-methods",
  ADMIN_GENERAL_SESSIONS: "/admin/general/sessions",
...
export const breadcrumbNameMap = {
  ...
  [ROUTES.ADMIN_CATEGORIES_CLASSES]: "Danh mục lớp học",
  [ROUTES.ADMIN_CATEGORIES_BATCHES]: "Danh mục khóa học",
  ...
  [ROUTES.ADMIN_GENERAL_PAYMENT_METHODS]: "Phương thức thanh toán",
  [ROUTES.ADMIN_GENERAL_SESSIONS]: "Phiên đăng nhập",
};
