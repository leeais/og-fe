...
import { STUDENT_MODAL_NAME } from "./utils";
import ModalStudent from "./components/ModalStudent";

export default function GeneralStudents() {
    ...
    <div className="p-4 bg-background space-y-2">
      <div className="flex items-center justify-between">
        ...
        <div className="space-x-2">
          <Button type="primary" onClick={() => openModal(STUDENT_MODAL_NAME)}>Thêm mới</Button>
      ...
      <ModalStudent name={STUDENT_MODAL_NAME} />
    </div>
  );
}
